...
function make_album(artNam:string, albTit:string):
{artNam:string, albTit:string}
{
...
const Dict1=make_album("Rafi","Oldies of 40's & 50's");
const Dict2=make_album("Lata","Melodies of 50's");
const Dict3=make_album("Talat","Ever Green Ghazal");
console.table(Dict1);
console.table(Dict2);
console.table(Dict3);